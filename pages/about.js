...
const About = () => {
    return (
        ...
        <div>
            ...
            <p>
            Manchester City's revenue was the fifth highest of a football club in the world in the 2018–19 season at €568.4 million. In 2019, Forbes estimated the club was the fifth most valuable in the world at $2.69 billion, The club is owned by the City Football Group Limited, a British-based holding company valued at £3.73 (US$4.8) billion in November 2019. The Abu Dhabi United Group holds primary interest in the holding company.
            </p>
        </div>
        </>
    );
